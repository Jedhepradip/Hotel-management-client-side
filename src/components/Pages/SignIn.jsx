...
//         Phone: phoneNumber
//       };
//       console.log("pradip handleSendOtp :", data);
...
//             {/* <RxCross2 onClick={handleClick} className='float-right text-2xl ml-5 text-red-500 font-extrabold' /> */}
...
//                   })} type="password" id="password" placeholder="Password." className="border border-gray-300 shadow p-3 w-full rounded mb-" />
//                   {errors.Password && <div className='block mb-2 font-bold  text-center text-red-500'>{errors.Password.message}</div>}
//                 </div>

//                 <NavLink to="/Login">
//                   <span className='text-blue-500 font-bold text-[15px] p-2 cursor-pointer'>Already have an account</span></NavLink>

//                 <div className="flex items-center justify-between">
//                   <button onClick={handleSendOtp}
//                     type='submit' className="bg-blue-500 mt-1 w-full border hover:bg-blue-700 text-white font-bold py-3 px-4 rounded focus:outline-none focus:shadow-outline">
//                     Send OTP
//                   </button>
//                 </div>
