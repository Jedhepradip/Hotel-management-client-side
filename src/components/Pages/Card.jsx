...
// import { fetchRoomsData } from '../CardSlice/CardDate';
...
//             }
//             if (response.ok) {
//                 console.log("likeData :",likeData.Rooms.likes.length);
//                 setupdate(likeData.Rooms.likes.length)
...
import { CardInformation, UserInfromation, fetchRoomsData } from '../CardSlice/CardDate';
import SignIn from './SignIn';
